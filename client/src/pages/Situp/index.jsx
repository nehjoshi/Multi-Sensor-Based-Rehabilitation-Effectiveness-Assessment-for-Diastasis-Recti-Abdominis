...
import { SubmitSitup } from './handler';
const Situp = () => {
    ...
    const TestEfficacy = async () => {
        setLoading(true);
        SubmitSitup(sensorValues.sen1, sensorValues.sen2, sensorValues.sen3, sensorValues.sen4)
            .then(res => {
                setMessage(res.data.result === 1 ? "Sit-up is being done correctly!" : "Sit-up is being done incorrectly! ");
                setLoading(false);
        ...
        <Layout center={true}>
            <div className={styles.box}>
                <div className={styles.header}>
                    <h1>Real-time Sit-Up Analysis</h1>
